...
<body id="body-pd">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12 mb-3">
                <button class="btn btn-green" data-toggle="modal" data-target="#addModal"> Add New Student </button>
                        ...
                        <tr id="{{$row->id}}">
                            ...
                            <td>
                                <a href="#" class="edit" data-toggle="modal"
                                    data-route="{{url('/students/edit/'.$row->id)}}" data-target="#editModal"><i
                                        class="bx bx-edit"></i></a>
                                <a href="#" class="delete" data-toggle="modal"
                                    data-route="{{url('/students/delete/'.$row->id)}}"><i class="bx bxs-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="updateStudent">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel">Edit Student</i></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="mobile" name="mobile" class="form-control"
                                value="{{ old('mobile') }}" autocomplete="moblie">
                        </div>

                        <div class="form-group">
                            <label>Phone Number*</label>
                            <input type="number" id="mobile1" name="mobile1" class="form-control"
                                value="{{ old('mobile1') }}" autocomplete="moblie1">
                        </div>
                        <h5>Account Information</h5>
                        <div class="form-group">
                            <label>E-mail</label>
    ...
    <script>
        ...
        $("#addStudent").submit(function (e) {
            e.preventDefault();
            var formData = new FormData(jQuery('#addStudent')[0]);
            $.ajax({
