    ...
    <form id="update-student">
        <div class="row">
            <div class="form-group col-md-4 mb-3">
                <label>ID</label>
                <input disabled type="text" id="id" name="id" class="form-control" value="{{$data->student_id}}"/>
                <span class="id text-danger"></span>
            </div>
            <div class="form-group col-md-8 mb-3">
                <label>Name</label>
                <input disabled type="text" id="name" name="name" class="form-control" value="{{$data->name}}"/>
                <span class="name text-danger"></span>
            </div>
            <div class="form-group col-md-4 mb-3">
                <label>Collage</label>
                <input disabled type="text" id="collage" class="form-control" name="collage" value="{{$collage->name}}">
                <span class="collage text-danger"></span>
            </div>
            <div class="form-group col-md-8 mb-3">
                <label>Major</label>
                 <input disabled type="text" id="major" class="form-control" name="major" value="{{$major->name}}">
            ...
            @if (count($mobile) > 1)
                ...
                <span class="mobile1 text-denger"></span>
            </div>
            @endif
