...
<div class="loader text-center">
  ...
  <header class="header" id="header">
    ...
    <h1 class="p-3">All Courses! <i class="bx bxs-user"></i> </h1>
    <div class="container-fluid">
        <div class="row">

            <div class="col-sm-12 mb-3">
                <button class="btn btn-green" data-toggle="modal" data-target="#exampleModal"> Add New Course </button>
    ...
    <tbody class="cont-data">
        ...
        <tr id="{{$row->id}}">
            ...
            <td>
                <a href="#" class="edit" data-toggle="modal" data-route="{{url('/courses/edit/'.$row->id)}}" data-target="#exampleModal2"><i class="bx bx-edit"></i></a>
                <a href="#" class="delete" data-toggle="modal" data-route="{{url('/courses/delete/'.$row->id)}}"><i class="bx bxs-trash"></i></a>
            </td>
        </tr>
        @endforeach
    </tbody>
    ...
    <div class="modal-content">
        <form id="addClient">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Credit</label>
                    <input type="number" name="credit"  class="form-control" autocomplete="city">
                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <form id="updateClient">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Edit Course</i></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
