...
<div class="loader text-center" id="loader">
        ...
        <div class="row">
            ...
            <form id="search-teachers-form">
                <div class=form-group>
                    <input type="search" id="search-teachers" name="search-teachers" class="form-control" />
                </div>
            </form>
            </div>
            <div class="col-sm-12">
                        ...
                        <tr id="{{$row->id}}">
                            ...
                            <td>
                                <a href="#" class="edit-teacher" data-toggle="modal"
                                    data-route="{{url('/teachers/edit/'.$row->id)}}" data-target="#edit-teacher-modal"><i
                                        class="bx bx-edit edit-color"></i></a>
                                <a href="#" class="delete-teacher" data-toggle="modal"
                                    data-route="{{url('/teachers/delete/'.$row->id)}}"><i class="bx bxs-trash delete-color"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
    ...
    <!-- add Modal -->
    <div class="modal fade" id="add-teacher-modal" tabindex="-1" role="dialog" aria-labelledby="add-teacher-modalLabel"
        aria-hidden="true">
                ...
                <form id="add-teacher">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <span class="degree text-danger"></span>
                        </div>
                        <div class="form-group">
                            <label>Major</label>
    ...
    <!--update Modal -->
    <div class="modal fade" id="edit-teacher-modal" tabindex="-1" role="dialog" aria-labelledby="edit-teacher-modalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="update-teacher">
                    <div class="modal-header">
                        <h4 class="modal-title" id="edit-teacher-modalLabel">Edit Teacher</i></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <script>
        ...
        $("#add-teacher").submit(function (e) {
            e.preventDefault();
            var formData = new FormData(jQuery('#add-teacher')[0]);
            $.ajax({
        ...
        //  update
        $("#update-teacher").submit(function (e) {
            e.preventDefault();
            var formData = new FormData(jQuery('#update-teacher')[0]);
            var idRow = $("#id").val();
            $.ajax({
        ...
        /**/
        $(document).on('keyup','#search-teachers',function(){
            var search = $(this).val();
