        ...
        <nav class="nav">
            <div>
                ...
                <a href="#" class="nav__logo">
                    <img src="{{asset('img/logo.jpg')}}" alt="" class="header__img">
    ...
    <div id="content">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                <div class="text-center" id="error"><p class="alert alert-danger">Invalide mastername or password</p></div>
                    <div class="card">

                        <div class="card-header bg-white text-center"><img src="{{asset('img/logo.jpg')}}" width="70px" /></div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="mastername" class="form-control" value="">
                                <span class="mastername text-danger"></span>
                            </div>
...
$("#master").submit(function (e) {
        e.preventDefault();
        var formData = new FormData(jQuery('#master')[0]);
        $.ajax({
            url: "{{url('/master/admin/add')}}",
            type: "POST",
            data: formData,
            cache: false,
            contentType: false,
